    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className={TW.waCard}>
          <div className="font-poppins text-[10px] tracking-[.2em] uppercase text-white/50 mb-5 flex items-center gap-2"><Phone size={13} />Your WhatsApp Number</div>
          ...
          <div className="mt-4 pt-4 border-t border-white/[.05]">
            <span className="block font-poppins text-[9px] text-white/35 mb-1">Your chat link:</span>
            <a href={chatLink} target="_blank" rel="noreferrer" className="text-[#25d366] font-poppins text-[11px] break-all">{chatLink}</a>
          </div>
        </div>

        <div className={TW.waCard}>
          <div className="font-poppins text-[10px] tracking-[.2em] uppercase text-white/50 mb-5 flex items-center gap-2"><Send size={13} />Send Quick Message</div>
      ...
      <div className="mt-10">
        ...
        <div className="flex gap-4 flex-wrap items-center">
          <a href={chatLink} target="_blank" rel="noreferrer" className="bg-[#25d366] text-white px-6 py-3.5 inline-flex items-center gap-2.5 font-poppins text-[10px] tracking-[.15em]" style={{ textDecoration: "none" }}>
            <Phone size={14} />Chat on WhatsApp
          </a>
          <span className="font-poppins text-[9px] text-white/25 tracking-[.1em]">Site-visible chat button</span>
        </div>
      </div>
    </>
  );
