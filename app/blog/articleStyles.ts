...
.fa-related-card:hover { border-color:rgba(123,143,252,.25); padding-left:36px; }
...
.fa-adjacent-card:hover { border-color:rgba(123,143,252,.4); background:rgba(255,222,89,.03); transform:translateY(-2px); }
...
.fa-share-btn:hover { border-color:rgba(123,143,252,.5); color:var(--gold); transform:translateY(-2px); }
/* Author card */
...
.fa-author-photo { width:72px; height:72px; border-radius:50%; object-fit:cover; object-position:top; flex-shrink:0; border:2px solid rgba(123,143,252,.3); }
...
.eval-checkbox-label:hover { color:var(--cream); border-color:rgba(123,143,252,.4); }
.eval-checkbox-label:has(input:checked) { background:rgba(123,143,252,.12); border-color:var(--gold); color:var(--gold); }
