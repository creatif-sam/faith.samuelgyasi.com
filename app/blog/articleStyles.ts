...
.bible-tooltip-text { font-family:var(--font-cormorant),'Cormorant Garamond',serif; font-size:16px; line-height:1.7; color:var(--cream); font-weight:300; margin-bottom:8px; }
.bible-tooltip-ref { font-family:'Space Mono',monospace; font-size:10px; letter-spacing:0.1em; text-transform:uppercase; color:var(--gold); font-weight:400; }
