  ...
  return (
    <div className="fixed bottom-20 right-4 sm:bottom-6 sm:right-6 z-[8000] flex flex-col items-end gap-3">
      ...
      {stage !== "closed" && (
        ...
        >
          {/* Gold accent bar */}
          <div className="h-[3px] w-full bg-[linear-gradient(90deg,#ffde59,#ff914d)]" />
              ...
              <div className="p-5 flex flex-col gap-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    maxLength={1000}
                    className="w-full bg-white/[.04] border border-white/[.09] rounded-lg text-[#eef0f5] font-[family-name:'Poppins',sans-serif] font-light text-sm px-3.5 py-2.5 outline-none transition-all focus:border-[rgba(212,168,67,.45)] focus:bg-white/[.06] focus:shadow-[0_0_0_3px_rgba(212,168,67,.08)] resize-none placeholder:text-white/20"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/[.04] border border-white/[.09] rounded-lg text-[#eef0f5] font-[family-name:'Poppins',sans-serif] font-light text-sm px-3.5 py-2.5 outline-none transition-all focus:border-[rgba(212,168,67,.45)] focus:bg-white/[.06] focus:shadow-[0_0_0_3px_rgba(212,168,67,.08)] placeholder:text-white/20"
                  />
                </div>
