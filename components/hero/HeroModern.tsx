      ...
      <div className={styles.heroContainer}>
        ...
        <div className={styles.contentSection}>
          ...
          <h1 className={styles.mainTitle}>
            <span className={styles.titleIntro}>{t.intro[lang]} </span>
            <span className={styles.titleName}>{t.name[lang]}</span>
            <span className={styles.titleRole}>{t.tagline[lang]}</span>
          </h1>
          ...
          <div className={styles.quote}>
            ...
            <p className={styles.quoteText}>{t.quote.text[lang]}</p>
            <p className={styles.quoteAttribution}>— {t.quote.attribution[lang]}</p>
          </div>
